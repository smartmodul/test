...
class Config:
    ...
    def __init__(self):
        ...
        self.flash['in,EVSE-MAX-CURRENT-A'] = '16'
        self.flash['in,MAX-CURRENT-FROM-GRID-A'] = '25'
        self.flash['in,PV-GRID-ASSIST-A'] = '6'
        self.flash['in,SOC'] = '0'
        ...
        self.flash["sw,ENABLE BALANCING"] = '0'
        self.flash['in,MODBUS-ID'] = '1'
        self.flash['btn,INVERTER-TYPE'] = '0'
        self.flash['INVERTER_IP_ADDR'] = '0'
        self.flash['chargeMode'] = '0'
        self.flash['ERRORS'] = '0'
    ...
    def get_ram_config(self) -> OrderedDict[str, int]:
        return self.ram

    def handle_ram_configure(self, variable: str, value: int) -> bool:
        try:
            if variable in self.ram:
                self.ram[variable] = int(value)
                return True
